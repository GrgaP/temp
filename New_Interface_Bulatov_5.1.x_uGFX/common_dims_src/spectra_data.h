...
extern const s16 spectra_data_clear[SPECTRA_DATA_CLEAR_NUMBER][1024];

extern const s16 spectra_data_TNTlevel1[SPECTRA_DATA_TNT_NUMBER][1024];
extern const s16 spectra_data_TNTlevel2[SPECTRA_DATA_TNT_NUMBER][1024]; 
extern const s16 spectra_data_TNTlevel3[SPECTRA_DATA_TNT_NUMBER][1024];
