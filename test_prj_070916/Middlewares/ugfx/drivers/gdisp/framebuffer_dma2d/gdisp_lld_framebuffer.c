...
#define DMA2D_ALPHA_PIXSZ 4
#define DMA2D_ALPHA_BUFF_H 272
#define DMA2D_ALPHA_BUFF_W 480
...
#define PIXIL_POS(g, x, y)		((y) * ((fbPriv *)(g)->priv)->fbi.linelen + (x) * 4)//sizeof(LLDCOLOR_TYPE))
