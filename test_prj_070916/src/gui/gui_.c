...
void TnD_print(void)
{
  ...
  static char DimeStr_buffer[8];
    ...
    DIMS_RTC_getStrT(TimeStr_buffer);
    //gdispFillArea(50, 45, 140, 30, BLACK);
    gdispControl(GDISP_CONTROL_ORIENTATION, (void *)GDISP_ROTATE_90);
    //gdispFillArea(81, 90, 110, 25, Orange);
    gdispDrawStringBox(81, 115, 110, 25, TimeStr_buffer, gdispOpenFont("DejaVuSans24_aa"), 0x7fffffff, 0);
    gdispControl(GDISP_CONTROL_ORIENTATION, (void *)GDISP_ROTATE_0);
    
    DIMS_RTC_getStrD(DimeStr_buffer);
    //gdispFillArea(50, 155, 140, 30, BLACK);
    

    gdispDrawStringBox(140, 120, 140, 30, DimeStr_buffer, gdispOpenFont("DejaVuSans24_aa"), 0x7fffffff, 0);
    
    HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, 0);
}

void Refresh_Timer_cb(void *param)
{
  //TnD_print();
...
void guiCreate(void)
{
  ...
  gtimerStart( &RefreshTimerId, Refresh_Timer_cb, 0, TRUE, 500);  
